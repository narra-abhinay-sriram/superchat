      ...
      <div className='mt-16 max-w-4xl mx-auto px-4 sm:px-6 md:px-8'>
        <nav className='bg-white p-3 sm:p-4 md:p-6 rounded-lg shadow-sm'>
          ...
          <p className='text-base sm:text-lg mb-6'>
            At SuperChat LLC ("we," "our," or "us"), we are committed to protecting your privacy and ensuring the security of any information we collect from you or about you. This Privacy Policy outlines our practices regarding the collection, use, and disclosure of your Personal Data when you use our website, applications, and services (collectively referred to as "Services").
          </p>
          <p className='text-base sm:text-lg mb-4'>
            This Privacy Policy does not apply to content processed on behalf of customers of our business offerings, such as our API. The use of that data is governed by our customer agreements.
          </p>
          ...
          <ul className='list-disc space-y-2 pl-4 sm:pl-8'>
            <li><a href='#personal-data' className='text-slate-700 hover:text-black hover:underline transition-colors'>Personal Data We Collect</a></li>
            <li><a href='#data-use' className='text-slate-700 hover:text-black hover:underline transition-colors'>How We Use Personal Data</a></li>
            <li><a href='#data-disclosure' className='text-slate-700 hover:text-black hover:underline transition-colors'>Disclosure of Personal Data</a></li>
            <li><a href='#data-retention' className='text-slate-700 hover:text-black hover:underline transition-colors'>Retention of Personal Data</a></li>
            <li><a href='#your-rights' className='text-slate-700 hover:text-black hover:underline transition-colors'>Your Rights</a></li>
            <li><a href='#children' className='text-slate-700 hover:text-black hover:underline transition-colors'>Children</a></li>
            <li><a href='#security' className='text-slate-700 hover:text-black hover:underline transition-colors'>Security</a></li>
            <li><a href='#changes' className='text-slate-700 hover:text-black hover:underline transition-colors'>Changes to the Privacy Policy</a></li>
            <li><a href='#contact' className='text-slate-700 hover:text-black hover:underline transition-colors'>How to Contact Us</a></li>
          </ul>
        </nav>

        <div className="mt-8 space-y-8">
          <section id='personal-data' className='scroll-mt-16'>
            <h2 className={`text-xl sm:text-2xl font-bold mb-4 ${subHeadingStyle}`}>1. Personal Data We Collect</h2>
            <div className='ml-2 sm:ml-4 space-y-4'>
              <p>We collect Personal Data relating to you ("Personal Data") as follows:</p>
              
              <div className="ml-4 space-y-4">
                <div>
                  <h3 className="font-semibold mb-2">Personal Data You Provide:</h3>We collect Personal Data when you create an account to use our Services or communicate with us, including:
                ...
                <div>
                  <h3 className="font-semibold mb-2">Personal Data We Receive from Your Use of the Services:</h3>When you visit, use, or interact with the Services, we receive the following information about your visit, use, or interactions 
                  <ul className="list-disc pl-4 pt-2 space-y-2">
          ...
          <section id='data-use' className='scroll-mt-16'>
            <h2 className={`text-xl sm:text-2xl font-bold mb-4 ${subHeadingStyle}`}>2. How We Use Personal Data</h2>
          ...
          <section id='data-disclosure' className='scroll-mt-16'>
            <h2 className={`text-xl sm:text-2xl font-bold mb-4 ${subHeadingStyle}`}>3. Disclosure of Personal Data</h2>
            <div className='ml-2 sm:ml-4'>
          ...
          <section id='data-retention' className='scroll-mt-16'>
            <h2 className={`text-xl sm:text-2xl font-bold mb-4 ${subHeadingStyle}`}>4. Retention of Personal Data</h2>
            <div className='ml-2 sm:ml-4'>
          ...
          <section id='your-rights' className='scroll-mt-16'>
            <h2 className={`text-xl sm:text-2xl font-bold mb-4 ${subHeadingStyle}`}>5. Your Rights</h2>
            <div className='ml-2 sm:ml-4'>
          ...
          <section id='children' className='scroll-mt-16'>
            <h2 className={`text-xl sm:text-2xl font-bold mb-4 ${subHeadingStyle}`}>6. Children</h2>
            <div className='ml-2 sm:ml-4'>
              <p>
          ...
          <section id='security' className='scroll-mt-16'>
            <h2 className={`text-xl sm:text-2xl font-bold mb-4 ${subHeadingStyle}`}>7. Security</h2>
            <div className='ml-2 sm:ml-4'>
              <p>
          ...
          <section id='changes' className='scroll-mt-16'>
            <h2 className={`text-xl sm:text-2xl font-bold mb-4 ${subHeadingStyle}`}>8. Changes to the Privacy Policy</h2>
            <div className='ml-2 sm:ml-4'>
              <p>
              We may update this Privacy Policy from time to time. When we do, we will publish an updated version and effective date on this page. Your continued use of the Services after any changes constitutes your acceptance of the new policy.              </p>
            </div>
          </section>

          <section id='contact' className='scroll-mt-16'>
            <h2 className={`text-xl sm:text-2xl font-bold mb-4 ${subHeadingStyle}`}>9. How to Contact Us</h2>
            <div className='ml-2 sm:ml-4'>
              <p>
